...
class AppUserAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        $tabCredientials = $this->getCredentials($request);
        $email = $tabCredientials['email'];
        ...
        $current_session["etablissement"] = $etablissement;

        $session->set("session", $current_session);
        
        return new RedirectResponse($this->urlGenerator->generate('home_auth', ['etablissement_id' => $etablissement->getId()]));
